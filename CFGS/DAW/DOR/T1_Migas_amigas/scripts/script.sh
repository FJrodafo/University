...
rm src/setupTests.js src/App.test.js src/reportWebVitals.js src/logo.svg
...
touch src/i18n.ts src/components/layout/Footer.js src/components/layout/HeaderNav.tsx src/constants/Langs.ts src/router/MisRutas.js src/views/Contacto.js src/views/Empanadas.js src/views/Error404.js src/views/Panaderia.js src/views/PasteleriaBolleria.js src/views/Principal.js
...
export default Principal;" > src/views/Principal.js
git add -A && git commit -m "Update Principal.js"
