package ListaPersonasArchivoTXT;
...
public class ListaPersonas {
    ...
    public void agregarPersona() {
        ...
        do {
            ...
            if (genero == 'H' || genero == 'h') {
                ...
                try {
                    BufferedWriter fw = new BufferedWriter(new FileWriter("src/ListaPersonasArchivoTXT/ListaPersonas.txt", true));
                    fw.newLine();
    ...
    public void eliminarPersona() {
        if (listaPersonas.isEmpty()) {
            ...
            if (!personaEncontrada) {
                ...
                try {
                    BufferedWriter fw = new BufferedWriter(new FileWriter("src/ListaPersonasArchivoTXT/ListaPersonas.txt"));
    ...
    public void listarPersonas() {
        if (listaPersonas.isEmpty()) {
            ...
            String contenido = "";
            try {
                BufferedReader fr = new BufferedReader(new FileReader("src/ListaPersonasArchivoTXT/ListaPersonas.txt"));
                int c;
                while ((c = fr.read()) != -1) {
                    contenido += (char) c;
                }
